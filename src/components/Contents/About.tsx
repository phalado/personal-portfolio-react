  ...
  return (
    <Container style={styles.container}>
      ...
      <p style={styles.paragraphs}>
        I love facing new challenges. Seeing a well-done job after hours and days of work is one of
        the best feelings that I ever experienced. And that is my fuel to work so hard: be able to,
        in the end, look at my newly completed work and be satisfied.
      </p>
      <p style={styles.paragraphs}>
        My logical thinking is one of my main work tools. I've been a developer for some years now,
        but I've always been a problem solver. For me, coding is like a puzzle to be put together
        and I know that I have all the pieces I need in reach - sometimes they will be on Stack
        Overflow, but, eventually, I will be able to reach them.
      </p>
      <p style={styles.paragraphs}>

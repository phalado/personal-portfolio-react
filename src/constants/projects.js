const projects = [
  {
    ...
    description: [
      ...
      'This game was done using Phaser 3 framework. Here you control Luke\'s X-Wing against some of the imperial ships. The objective is to destroy as much enemy ships as you can and score high. Maybe you can erase my name from the leader board, give it a try!',
    ],
  ...
  },
  {
    ...
    description: [
      ...
      'The cloned site was The Next Web. You can see that our project is responsive to four different screen sizes.',
  ...
  },
  {
    ...
    description: [
      ...
      'The objective here was to use the framework Bootstrap to clone the Newsweek website making a responsive page.',
    ],
  ...
  },
  {
    ...
    description: [
      ...
      'For more information about why and how it was done visit my article in Medium - https://medium.com/p/bdfe7069be2d/.',
    ],
